...
use foodie_core::ports::incoming::authorization::login_command::{
...
impl From<UserLoginJson> for Request {
    fn from(val: UserLoginJson) -> Self {
        Request::new(val.email, val.password)
    }
}
