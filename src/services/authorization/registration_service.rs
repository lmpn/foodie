use crate::services::{
    domain::{filtered_user::FilteredUser, user::User},
    ports::{
        incoming::registration_service::{RegistrationService, RegistrationServiceError},
        outgoing::insert_user_port::{InsertUserError, InsertUserPort},
    },
};
use argon2::{
